     ...
     <aside id="sidebar-wrapper">
         ...
         <ul class="sidebar-menu">
             ...
             <li class="dropdown">
                 ...
                 <ul class="dropdown-menu">
                     <li><a class="nav-link" href="{{ route('admin.why-choose-us.index') }}">
                             >Why Choose Us</a></li>
                     <li><a class="nav-link" href="{{ route('admin.banner-slider.index') }}">
                             >Banner Slider</a></li>
                     <li><a class="nav-link" href="{{ route('admin.chefs.index') }}">
                             >Chefs</a></li>
                 </ul>
             </li>
             ...
             <li class="dropdown">
                 <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                         class="fas fa-columns"></i> <span>Manage Reservations </span></a>
                 <ul class="dropdown-menu">
