                 ...
                 $.ajax({
                     ...
                     success: function(response) {
                         ...
                         $.each(response, function(index, message) {
                             ...
                             let html = `<div class="chat-item ${message.sender_id == userId ? "chat-right" : "chat-left"} " style=""><img style="width:50px;height:50px;object-fit:cover;" src="${avatar}">
