     ...
     <div class="container">
         ...
         <div class="collapse navbar-collapse" id="navbarNav">
             ...
             <ul class="menu_icon d-flex flex-wrap">
                 ...
                 @php
                     @$unseenMessages = auth()->check()
                         ? \App\Models\Chat::where([
                             'sender_id' => 1,
 ...
 <div class="fp__menu_cart_area">
     <div class="fp__menu_cart_boody">
         <div class="fp__menu_cart_header">
             <h5>total item (<span class="cart_count"
                     style="font-size: 16px"><b>{{ count(Cart::content()) }}</b></span>)</h5>
                 ...
                 <div class="modal-body">
                     <form class="fp__reservation_form" action="{{ route('reservation.store') }}" method="POST">
                        @csrf
                         ...
                         <select class="reservation_input nice_select" name="time">
