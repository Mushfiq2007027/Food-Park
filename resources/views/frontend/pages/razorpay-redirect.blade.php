...
<body>
    ...
    <form action="{{ route('razorpay.payment') }}" method="POST">
        ...
        <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="{{ config('gatewaySettings.razorpay_api_key') }}"
            data-currency="{{ config('gatewaySettings.razorpay_currency') }}" data-amount="{{  $payableAmount }}" data-buttontext="Pay"
            data-name="Payment" data-descritpion="Payment for product" data-prefill.name="Jhon"
